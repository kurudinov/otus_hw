...
exports.createOrder = function (userId, sum, name, productCode, productName, quantity, deliveryDate, address, callback) {
    
    db.query(`INSERT INTO ${ORDERS_TABLE} ("UserId", "Sum", "Name", "ProductCode", "ProductName", "Quantity", "DeliveryDate", "Address", "Status", "CreatedAt") 
        VALUES ($1, $2, $3, $4, $5, $6, $7, $8, 'CREATED', NOW()) RETURNING "Number"`, [userId, sum, name, productCode, productName, quantity, deliveryDate, address], (err, result) => {
        if (err) {
            callback(err);
        } else {
            db.query(`SELECT *  FROM ${ORDERS_TABLE}
