...
const runKafkaConsumer = async () => {
    ...
    await consumer.subscribe({ topics: [topicUserReg, topicPaymentRequest, topicReturnRequest], 
        fromBeginning: true });
...
var handleEventPaymentRequest = async function (message) {
    ...
    billingModel.payForOrderFunc(msg.userId, parseFloat(msg.sum), msg.orderNumber, (err, result) => {
        if (err) {
